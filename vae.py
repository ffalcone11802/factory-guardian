...
class VAE(nn.Module):
    ...
    def __init__(self, img_size=256, nb_channels=3, latent_img_size=32, z_dim=256, rec_loss="xent", beta=1, delta=1):
        '''
        '''
        ...
        self.resnet = resnet18(progress=False)
    ...
    def step(self, input_mb):
        recon_mb, _, _ = self.forward(input_mb)
